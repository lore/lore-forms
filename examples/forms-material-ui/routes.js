...
export default (
  <Route component={UserIsAuthenticated(withMuiTheme(Master))}>
    ...
    <Route path="/" component={Layout}>
      ...
      {/* Forms: Create */}
      <Route path="forms-create-optimistic" component={(props) => getFormLayout(props, 'Form: Create - Optimistic', 'forms-create-optimistic')}>
        <IndexRoute component={FormsCreateOptimisticLayout} />
      </Route>
      <Route path="forms-create-overlay" component={(props) => getFormLayout(props, 'Form: Create - Overlay', 'forms-create-overlay')}>
        <IndexRoute component={FormsCreateOverlayLayout} />
      </Route>
      <Route path="forms-create-wizard" component={(props) => getFormLayout(props, 'Form: Create - Wizard', 'forms-create-wizard')}>
        <IndexRoute component={FormsCreateWizardLayout} />
      </Route>
      <Route path="forms-create-wizard-generic" component={(props) => getFormLayout(props, 'Form: Create - Wizard - Generic', 'forms-create-wizard-generic')}>
        <IndexRoute component={FormsCreateWizardGenericLayout} />
      </Route>

      {/* Forms: Update */}
      <Route path="forms-update-optimistic" component={(props) => getFormLayout(props, 'Form: Update - Optimistic', 'forms-update-optimistic')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={FormsUpdateOptimisticLayout} />
      </Route>
      <Route path="forms-update-overlay" component={(props) => getFormLayout(props, 'Form: Update - Overlay', 'forms-update-overlay')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={FormsUpdateOverlayLayout} />
      </Route>
      <Route path="forms-update-wizard" component={(props) => getFormLayout(props, 'Form: Update - Wizard', 'forms-update-wizard')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={FormsUpdateWizardLayout} />
      </Route>
      <Route path="forms-update-wizard-generic" component={(props) => getFormLayout(props, 'Form: Update - Wizard - Generic', 'forms-update-wizard-generic')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={FormsUpdateWizardGenericLayout} />
      </Route>

      {/* Forms: Destroy */}
      <Route path="forms-destroy-optimistic" component={(props) => getFormLayout(props, 'Form: Destroy - Optimistic', 'forms-destroy-optimistic')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={FormsDestroyOptimisticLayout} />
      </Route>
      <Route path="forms-destroy-overlay" component={(props) => getFormLayout(props, 'Form: Destroy - Overlay', 'forms-destroy-overlay')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={FormsDestroyOverlayLayout} />
      </Route>
      <Route path="forms-destroy-wizard" component={(props) => getFormLayout(props, 'Form: Destroy - Wizard', 'forms-destroy-wizard')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={FormsDestroyWizardLayout} />
      </Route>
      <Route path="forms-destroy-wizard-generic" component={(props) => getFormLayout(props, 'Form: Destroy - Wizard - Generic', 'forms-destroy-wizard-generic')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={FormsDestroyWizardGenericLayout} />
      </Route>

      {/* Dialogs: Create */}
      <Route path="dialogs-create-optimistic" component={(props) => getLayout(props, 'Dialog: Create - Optimistic', 'dialogs-update-optimistic')}>
        <IndexRoute component={DialogsCreateOptimisticLayout} />
      </Route>
      <Route path="dialogs-create-overlay" component={(props) => getLayout(props, 'Dialog: Create - Overlay', 'dialogs-update-overlay')}>
        <IndexRoute component={DialogsCreateOverlayLayout} />
      </Route>
      <Route path="dialogs-create-wizard" component={(props) => getLayout(props, 'Dialog: Create - Wizard', 'dialogs-update-wizard')}>
        <IndexRoute component={DialogsCreateWizardLayout} />
      </Route>
      <Route path="dialogs-create-wizard-generic" component={(props) => getLayout(props, 'Dialog: Create - Wizard - Generic', 'dialogs-update-wizard-generic')}>
        <IndexRoute component={DialogsCreateWizardGenericLayout} />
      </Route>

      {/* Dialogs: Update */}
      <Route path="dialogs-update-optimistic" component={(props) => getLayout(props, 'Dialog: Update - Optimistic', 'dialogs-update-optimistic')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={DialogsUpdateOptimisticLayout} />
      </Route>
      <Route path="dialogs-update-overlay" component={(props) => getLayout(props, 'Dialog: Update - Overlay', 'dialogs-update-overlay')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={DialogsUpdateOverlayLayout} />
      </Route>
      <Route path="dialogs-update-wizard" component={(props) => getLayout(props, 'Dialog: Update - Wizard', 'dialogs-update-wizard')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={DialogsUpdateWizardLayout} />
      </Route>
      <Route path="dialogs-update-wizard-generic" component={(props) => getLayout(props, 'Dialog: Update - Wizard - Generic', 'dialogs-update-wizard-generic')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={DialogsUpdateWizardGenericLayout} />
      </Route>

      {/* Dialogs: Destroy */}
      <Route path="dialogs-destroy-optimistic" component={(props) => getLayout(props, 'Dialog: Destroy - Optimistic', 'dialogs-destroy-optimistic')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={DialogsDestroyOptimisticLayout} />
      </Route>
      <Route path="dialogs-destroy-overlay" component={(props) => getLayout(props, 'Dialog: Destroy - Overlay', 'dialogs-destroy-overlay')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={DialogsDestroyOverlayLayout} />
      </Route>
      <Route path="dialogs-destroy-wizard" component={(props) => getLayout(props, 'Dialog: Destroy - Wizard', 'dialogs-destroy-wizard')}>
        <IndexRoute component={EmptyView} />
        <Route path=":tweetId" component={DialogsDestroyWizardLayout} />
      </Route>
      <Route path="dialogs-destroy-wizard-generic" component={(props) => getLayout(props, 'Dialog: Destroy - Wizard - Generic', 'dialogs-destroy-wizard-generic')}>
        <IndexRoute component={EmptyView} />
