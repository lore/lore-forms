  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        'lore-hook-dialog-material-ui': path.resolve(__dirname, '../../packages/lore-hook-dialog-material-ui/src'),
        'lore-hook-dialogs-material-ui': path.resolve(__dirname, '../../packages/lore-hook-dialogs-material-ui/src'),
